...
namespace EliseyAgGameEngine {
	...
	GLfloat positions_colors_coords[] = {
		// front
		-1.0f, -1.f, -1.f, 1.0f,  0.0f, 0.0f,  10.f, 0.f,
		-1.0f,  1.f, -1.f, 0.0f,  1.0f, 0.0f,  0.f,  0.f,
		-1.0f, -1.f,  1.f, 0.0f,  0.0f, 1.0f,  10.f, 10.f,
		-1.0f,  1.f,  1.f, 1.0f,  0.0f, 0.0f,  0.f,  10.f,
    ...
    int Application::start(unsigned int window_width, unsigned int window_height, const char* title) {
		...
		p_cube_positions_colors_vbo = std::make_unique<VertexBuffer>(positions_colors_coords, sizeof(positions_colors_coords), buffer_layout_vec3_vec3_vec2);
